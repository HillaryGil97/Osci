import {startMe} from "./control.js"
...
configOsci.CH1.vol = localStorage.getItem('volCH1')*(41*(1/20))
configOsci.valTimer = localStorage.getItem('frecCH1')*0.09 * 5
configOsci.CH2.vol = localStorage.getItem('volCH2')
